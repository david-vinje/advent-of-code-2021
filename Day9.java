...
public class Day9 {
    ...
    public static void part2(File file) throws FileNotFoundException {
        ...
        if (leftLower < table.get(height - 2).get(0) && leftLower < table.get(height - 1).get(1)) {
            // lowPoints *= basin(table, height - 1, 0, 1);
        ...
        if (rightLower < table.get(height - 2).get(width - 1) && rightLower < table.get(height - 1).get(width - 2)) {
            // lowPoints *= basin(table, height - 1, width - 1, 1);
     ...
     * }
     * if (rightUpper < table.get(0).get(width - 2) && rightUpper <
     * table.get(1).get(width - 1)) {
     ...
     * }
     * if (rightLower < table.get(height - 2).get(width - 1) && rightLower <
     * table.get(height - 1).get(width - 2)) {
